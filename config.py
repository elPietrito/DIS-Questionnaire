...
AUDIO1_GRAMMAR_QUESTION = "Est-ce que la dernière réplique dite ou entendue pendant le rêve est grammaticalement correcte pour vous ? Sinon, quelle aurait été la formulation correcte ?"

# Likert scale questions for Audio 1
# ADD/REMOVE questions by editing this list
PART2_AUDIO1_LIKERT_QUESTIONS = [
    "Sur une échelle de 1 à 6, évaluez votre niveau de surprise concernant la dernière réplique pendant le rêve",  # ← Edit question text here
]

# Yes/No questions for Audio 1
# ADD/REMOVE questions by editing this list
PART2_AUDIO1_YESNO_QUESTIONS = [
    "Est-ce que la dernière réplique était cohérente dans le contexte du rêve ?",  # ← Edit question text here
...
# Grammar correction question (open text)
AUDIO2_GRAMMAR_QUESTION = "Est-ce que l'avant-dernière réplique dite ou entendue pendant le rêve est grammaticalement correcte pour vous ? Sinon, quelle aurait été la formulation correcte ?"
...
PART2_AUDIO2_YESNO_QUESTIONS = [
    "Est-ce que l'avant-dernière réplique était cohérente dans le contexte du rêve ?",  # ← Edit question text here
